...
(function() {
        ...
        function n(n) {
            function l(e) {
                if (o !== e) {
                    ...
                    if (!u) tracery.addError("multiple possible expansion symbols in tag!" + n);
                    else {
                        u = !1;
                        var r = t.split(".");
                        a = r[0],
    ...
    function() {
        ...
        return e.prototype.activate = function() {
            ...
            if (this.subactions) for (var s = 0; s < this.subactions.length; s++) this.subactions[s].activate()
        },
        e.prototype.deactivate = function() {
            if (this.subactions) for (var e = 0; e < this.subactions.length; e++) this.subactions[e].deactivate();
    ...
    function(e, t) {
        ...
        i = Class.extend({
            ...
            expandChildren: function() {
                if (this.children) {
                    this.childText = "";
                    for (var e = 0; e < this.children.length; e++) this.children[e].expand(),
        ...
        o = i.extend({
            init: function(e, t) {
                ...
                if (t === null || typeof t != "object") {
                    if (! (typeof t == "string" || t instanceof String)) throw console.log("Unknown tagNode input: ", t),
            ...
            expand: function() {
                ...
                this.rule.error && (this.error = this.rule.error, tracery.addError(this.error)),
                this.actions = [],
                ...
                this.finalText = this.childText;
                for (var t = 0; t < this.mods.length; t++) this.finalText = this.grammar.applyMod(this.mods[t], this.finalText)
            },
            toLabel: function() {
                return this.symbol
            },
    ...
    function(e) {
        ...
        n = function(e) {
            if (e.constructor === Array) e = e.slice(0, e.length);
                ...
                if (! (typeof e == "string" || e instanceof String)) throw console.log(e),
            ...
            this.startUses = [],
            this.totalUses = 0;
            for (var r = 0; r < this.rules.length; r++) this.uses[r] = 0,
            this.startUses[r] = this.uses[r],
            this.totalUses += this.uses[r]
        };
        return n.prototype.parseAll = function(t) {
            for (var n = 0; n < this.rules.length; n++) this.rules[n].prototype !== e && (this.rules[n] = new e(this.rules[n]))
        },
        ...
        n.prototype.getIndex = function() {
            ...
            n = 0;
            while (this.uses[e] > t && n < 20) e = this.getRandomIndex(),
            n++;
            return e
        },
        n.prototype.decayUses = function(e) {
            this.totalUses = 0;
            for (var t = 0; t < this.uses; t++) this.uses[index] *= 1 - e,
        ...
        n.prototype.testRandom = function() {
            ...
            for (var t = 0; t < this.uses.length; t++) console.log(t + ":   " + e[t] + "    " + this.uses[t])
        },
    ...
    n("grammar", ["./modifiers", "./node", "./symbol", "./rule/rule"],
    function(e, t, n, r) {
        function i() {
            this.clear()
        }
        ...
        i.prototype.applyMod = function(e, t) {
            if (!this.modifiers[e]) throw console.log(this.modifiers),
            "Unknown mod: " + e;
        ...
        i.prototype.analyze = function() {
            this.symbolNames = [];
            for (var e in this.symbols) this.symbols.hasOwnProperty(e) && this.symbolNames.push(e);
            for (var t = 0; t < this.symbolNames.length; t++) {
                var n = this.symbolNames[t],
                r = this.symbols[n];
    ...
    n("traceryCore", ["./utilities", "./grammar", "./node"],
    function(e, t, n) {
        var r = {};
