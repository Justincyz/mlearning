#! /usr/bin/env python
# -*- coding: utf-8 -*-
#python get_score.py --key 59bad889c38b80053b671572 --secret LfMMot8Rlmkxt9ZQEb5o8CMQBewL77IH9jE5WyrVkg4 --name content.txt
#
import argparse
import json
import random
...
if __name__ == '__main__':
    ...
    args.key = '59bad889c38b80053b671572'
    args.secret = 'LfMMot8Rlmkxt9ZQEb5o8CMQBewL77IH9jE5WyrVkg4'
    ...
    with open('get_score.json', 'w') as fp:
        fp.write('[')
        with open('tweet.txt', 'r') as my_file:
            for line in my_file:
    ...
    with open('get_score.json', 'rb+') as filehandle:
